...
public class DevInfo extends AbstractLog<DevInfo> {
  private static final TextChannel LOGGING_CHANNEL = Jinx.instance == null ?
      null : Jinx.instance.getClient().getTextChannelById(Const.Channels.DEV_LOGGING_CHANNEL);
  ...
  public DevInfo doCommand(DiscordUser user, String command, String full) {
    ...
    if (LOGGING_CHANNEL == null) System.err.println(this);
    else LOGGING_CHANNEL.sendMessage(StringUtils.keep(toString(), 2000)).queue();
    return this;
  }
